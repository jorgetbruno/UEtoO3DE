...
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_import_chunks.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_collider_pairs.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_slot_labels.py"
if %ERRORLEVEL% NEQ 0 goto :failed
...
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_chunk.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_png.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_orphan_tests.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_scratch_level.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_lod_chain.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_material_wait.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_collision_modes.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_material_blends.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_lod_reduce.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_texcap.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_export_parallel.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_material_report.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_landscape_layer.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_render_framing.py"
if %ERRORLEVEL% NEQ 0 goto :failed
%PY% "%REPO%\Tests\perf\test_knob_effects.py"
if %ERRORLEVEL% NEQ 0 goto :failed
